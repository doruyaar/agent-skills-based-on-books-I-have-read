...
Rules distilled from *Refactoring* by Martin Fowler. Use the first half to name what is wrong with the code, and the second half to pick the refactoring that fixes it.
